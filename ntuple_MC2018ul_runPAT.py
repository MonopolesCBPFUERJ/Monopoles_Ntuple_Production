...
process.Monopoler = cms.EDAnalyzer(
    ...
    #Output = cms.string("/eos/user/t/tmenezes/Monopole_Ntuples/PrivateProduction_SpinHalf_DrellYan/25July_G4SimHits.root"),
    ...
    EcalESRecHits = cms.InputTag("reducedEcalRecHitsES"),
    ...
    simHitsEE = cms.InputTag("g4SimHits", "EcalHitsEE", "SIM"),
    simHitsES = cms.InputTag("g4SimHits", "EcalHitsES", "SIM"),
    simHitsHCAL = cms.InputTag("g4SimHits", "HcalHits", "SIM"),
    simHitsPixelBarrel = cms.InputTag("g4SimHits", "TrackerHitsPixelBarrelLowTof", "SIM"),
    simHitsPixelEndcap = cms.InputTag("g4SimHits", "TrackerHitsPixelEndcapLowTof", "SIM"),
    simHitsTIB = cms.InputTag("g4SimHits", "TrackerHitsTIBLowTof", "SIM"),
    simHitsTID = cms.InputTag("g4SimHits", "TrackerHitsTIDLowTof", "SIM"),
    simHitsTOB = cms.InputTag("g4SimHits", "TrackerHitsTOBLowTof", "SIM"),
    simHitsTEC = cms.InputTag("g4SimHits", "TrackerHitsTECLowTof", "SIM"),
