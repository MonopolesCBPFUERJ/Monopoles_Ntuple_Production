...
### Add the L1 Prefiring Weight Producer
# account for the prefiring effect in ECAL and muon triggers
#process.load("PhysicsTools.PatUtils.L1PrefiringWeightProducer_cfi")
#process.prefiringweight_step = cms.Path(process.L1PrefiringWeightProducer)
#process.schedule.append(process.prefiringweight_step)
